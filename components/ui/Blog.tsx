        ...
        <div className='w-full bg-white py-10'>
            <div className="w-full max-w-6xl m-auto flex items-center justify-center p-10 flex-col">
                <div className="flex flex-col my-5 text-center max-w-3xl">
                    ...
                    <p className='text-gray-500 text-sm'>The Nexcent blog is the best place to read about the latest membership insights, trends and more. See who's joining the community, read about how our community are increasing their membership income and lot's more.​</p>
                </div>
